...
public class TextUtils {
     ...
     */
    public static boolean isEmpty(final @Nullable String string) {
     ...
     */
    public static boolean equals(final @Nullable String a, final @Nullable String b) {
     ...
     */
    @Nullable
    public static String toLowerCase(final @Nullable String string) {
     ...
     */
    @Nullable
    public static String toUpperCase(final @Nullable String string) {
